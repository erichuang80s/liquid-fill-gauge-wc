 ...
 */
var _a;
const t$2 = globalThis, e$4 = t$2.ShadowRoot && (void 0 === t$2.ShadyCSS || t$2.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, s$1 = Symbol(), o$3 = /* @__PURE__ */ new WeakMap();
let n$4 = class n {
...
const r$5 = (t2) => new n$4("string" == typeof t2 ? t2 : t2 + "", void 0, s$1), i$3 = (t2, ...e2) => {
  const o2 = 1 === t2.length ? t2[0] : e2.reduce((e3, s2, o3) => e3 + ((t3) => {
    if (true === t3._$cssResult$) return t3.cssText;
    if ("number" == typeof t3) return t3;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + t3 + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(s2) + t2[o3 + 1], t2[0]);
  return new n$4(o2, t2, s$1);
}, S$1 = (s2, o2) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: i$2, defineProperty: e$3, getOwnPropertyDescriptor: r$4, getOwnPropertyNames: h$1, getOwnPropertySymbols: o$2, getPrototypeOf: n$3 } = Object, a$1 = globalThis, c$1 = a$1.trustedTypes, l$1 = c$1 ? c$1.emptyScript : "", p$1 = a$1.reactiveElementPolyfillSupport, d$1 = (t2, s2) => t2, u$1 = { toAttribute(t2, s2) {
  switch (s2) {
    case Boolean:
      t2 = t2 ? l$1 : null;
      break;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1 = globalThis, i$1 = t$1.trustedTypes, s = i$1 ? i$1.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, e$2 = "$lit$", h = `lit$${Math.random().toFixed(9).slice(2)}$`, o$1 = "?" + h, n$2 = `<${o$1}>`, r$3 = document, l = () => r$3.createComment(""), c = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, a = Array.isArray, u = (t2) => a(t2) || "function" == typeof (t2 == null ? void 0 : t2[Symbol.iterator]), d = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, v = /-->/g, _ = />/g, m = RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), p = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t2) => (i2, ...s2) => ({ _$litType$: t2, strings: i2, values: s2 }), b2 = y(2), T = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), A = /* @__PURE__ */ new WeakMap(), C = r$3.createTreeWalker(r$3, 129);
function P(t2, i2) {
...
const V = (t2, i2) => {
  ...
  for (let i3 = 0; i3 < s2; i3++) {
    ...
    l2 += c2 === f ? s3 + n$2 : d2 >= 0 ? (o2.push(a2), s3.slice(0, d2) + e$2 + s3.slice(d2) + h + x) : s3 + h + (-2 === d2 ? i3 : x);
  }
 ...
 */
function r2(r3) {
  return n$1({ ...r3, state: true, attribute: false });
}
/**
 * @license
 * Copyright 2017 Google LLC
...
function e(e2, r3) {
  return (n3, s2, i2) => {
    ...
    {
      const { get: e3, set: r4 } = "object" == typeof s2 ? n3 : i2 ?? (() => {
        const t2 = Symbol();
        return { get() {
          return this[t2];
        }, set(e4) {
...
function generateSineWave(input) {
  ...
  for (let x = 0; x <= width; x++) {
    const y2 = amplitude * Math.sin(frequency * x + phaseShift);
    path.lineTo(x, y2);
  }
...
let n2 = 0;
function uid(prifix = "liquid-fill-gauge") {
  return `${prifix}-${n2++}`;
}
...
let LiquidFillGauge = class extends r$2 {
  constructor() {
    super(...arguments);
    this.width = 256;
    this.height = 256;
    ...
    this._animate = animate({
      ...
      callback: () => {
        ...
        if (this._tweenValue) {
          ...
          this.stateValue = Number(v2.toFixed(2));
        }
  ...
  _updateWavePath() {
    ...
    const d2 = generateSineWave({ width: width + period, height, phaseShift: _phaseShift, amplitude, frequency });
    if (this._wavePath)
      this._wavePath.setAttribute("d", d2);
  }
  _setupScale() {
  ...
  render() {
    ...
    const wavePath = b2`<path id="wave-path" transform="translate(${_translateX} ${_translateY})"></path>`;
    const content = b2`
...
__decorateClass([
  e("#wave-path")
], LiquidFillGauge.prototype, "_wavePath", 2);
__decorateClass([
  e("#value-group")
], LiquidFillGauge.prototype, "_valueGroup", 2);
__decorateClass([
  n$1({ type: Number })
...
__decorateClass([
  r2()
], LiquidFillGauge.prototype, "stateValue", 2);
__decorateClass([
  n$1({ type: Number })
], LiquidFillGauge.prototype, "fps", 1);
__decorateClass([
  n$1({ type: Number })
], LiquidFillGauge.prototype, "frequency", 1);
__decorateClass([
  n$1({ type: Number })
], LiquidFillGauge.prototype, "amplitude", 1);
__decorateClass([
  n$1({ type: Number })
