...
b$1.elementStyles = [], b$1.shadowRootOptions = { mode: "open" }, b$1[d$1("elementProperties")] = /* @__PURE__ */ new Map(), b$1[d$1("finalized")] = /* @__PURE__ */ new Map(), p$1 == null ? void 0 : p$1({ ReactiveElement: b$1 }), (a$1.reactiveElementVersions ?? (a$1.reactiveElementVersions = [])).push("2.0.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1 = globalThis, i = t$1.trustedTypes, s$1 = i ? i.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, e = "$lit$", h = `lit$${(Math.random() + "").slice(9)}$`, o$1 = "?" + h, n$1 = `<${o$1}>`, r$3 = document, l = () => r$3.createComment(""), c = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, a = Array.isArray, u = (t2) => a(t2) || "function" == typeof (t2 == null ? void 0 : t2[Symbol.iterator]), d = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, v = /-->/g, _ = />/g, m = RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), p = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t2) => (i2, ...s2) => ({ _$litType$: t2, strings: i2, values: s2 }), b2 = y(2), w = Symbol.for("lit-noChange"), T = Symbol.for("lit-nothing"), A = /* @__PURE__ */ new WeakMap(), E = r$3.createTreeWalker(r$3, 129);
function C(t2, i2) {
      ...
      >
        <defs>
          <clipPath id="clipPathWave" transform="${translateCenter}">
            <path d="${d2}" transform="translate(${_translateX} ${_translateY})"></path>
          </clipPath>
        </defs>
...
], WaveSvg.prototype, "width", 2);
__decorateClass([
  n2({ type: Number, reflect: true })
], WaveSvg.prototype, "height", 2);
__decorateClass([
  n2({ type: Number, reflect: true })
], WaveSvg.prototype, "amplitude", 2);
__decorateClass([
  n2({ type: Number, reflect: true })
], WaveSvg.prototype, "frequency", 2);
__decorateClass([
  n2({ type: Number, reflect: true })
], WaveSvg.prototype, "phaseShift", 2);
__decorateClass([
  n2({ type: Number, reflect: true })
], WaveSvg.prototype, "min", 2);
__decorateClass([
  n2({ type: Number, reflect: true })
], WaveSvg.prototype, "max", 2);
__decorateClass([
  n2({ type: Number, reflect: true })
], WaveSvg.prototype, "value", 1);
__decorateClass([
  r()
], WaveSvg.prototype, "_isFirstRender", 2);
__decorateClass([
  r()
], WaveSvg.prototype, "_translateX", 2);
__decorateClass([
  r()
], WaveSvg.prototype, "_translateY", 2);
__decorateClass([
  r()
], WaveSvg.prototype, "_beforeY", 2);
__decorateClass([
  r()
], WaveSvg.prototype, "_stateValue", 2);
__decorateClass([
  r()
], WaveSvg.prototype, "_beforeValue", 2);
__decorateClass([
  r()
], WaveSvg.prototype, "_insideWidth", 2);
WaveSvg = __decorateClass([
  t("liquid-fill-gauge")
], WaveSvg);
export {
  WaveSvg
