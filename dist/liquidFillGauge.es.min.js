...
let LiquidFillGauge = class extends s {
  constructor() {
    super(...arguments);
    this.width = 256;
    this.height = 256;
  ...
  render() {
    ...
    `;
    const wavePath = b2`<path d="${d2}" transform="translate(${_translateX} ${_translateY})"></path>`;
    const clipPathWave2 = isSlot ? b2`
...
__decorateClass([
  r()
], LiquidFillGauge.prototype, "_isFirstRender", 2);
__decorateClass([
  r()
], LiquidFillGauge.prototype, "_translateX", 2);
__decorateClass([
  r()
], LiquidFillGauge.prototype, "_translateY", 2);
__decorateClass([
  r()
], LiquidFillGauge.prototype, "_beforeY", 2);
__decorateClass([
  r()
], LiquidFillGauge.prototype, "_stateValue", 2);
__decorateClass([
  r()
], LiquidFillGauge.prototype, "_beforeValue", 2);
__decorateClass([
  r()
], LiquidFillGauge.prototype, "_insideWidth", 2);
